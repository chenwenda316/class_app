<template>
<div style="margin:auto;background: 50% 100%/cover url('https://s1.ax1x.com/2023/02/16/pS7vzkV.jpg');height:calc(100vh - 60px);">
        ...
        <n-grid-item span="4">
            <n-card :bordered="false" style="backdrop-filter: blur(10px);background-color:rgba(255,255,255,0.7)">
                ...
                <n-progress
                    ...
                    height = "2vh"
                    fill-border-radius="1vh 0 0 1vh"
                    processing
                />
            </n-card>
            <n-card :bordered="false" style="backdrop-filter: blur(10px);background-color:rgba(255,255,255,0.7);margin-top:30px;" v-if="onDev">
                <n-space vertical>
...
export default {
  ...
  data() {
    let classDataOrigin=[
        ...
        {name:"自习",time:"13:00",type:"",duration:90},
        {name:"选修",time:"14:45",type:"",duration:90},
        ],
        [
    ...
    let shiftDataOrigin = [
        ...
        [{name:"许景宁",tags:["组长"]}, {name:"过德麟",tags:["组员"]}, {name:"陈文达",tags:["黑板"]}, {name:"徐梓宸",tags:["黑板"]}, {name:"周鼎宸",tags:["扫地"]},{name:"李谨硕",tags:["摆烂"]}],
    ]
    let groupLeaders = [
        // {
        //   label: "请选择", value: -1,
