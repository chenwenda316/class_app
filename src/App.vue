 ...
 * @LastEditTime: 2023-02-25 20:01:55
  ...
  <n-message-provider>
    <n-layout>
      <n-layout has-sider>
        ...
        <n-layout-content
          ref="containerRef"
          content-style="padding:0px;height:100vh;background: center/cover url('https://s1.ax1x.com/2023/02/16/pS7vvT0.jpg');"
        >
          <n-scrollbar ref="mscrollbar" style="max-height: 100vh">
            <RouterView
              style="padding: 30px"
              @change-collapsed-width="changeCollapsedWidth"
            />
            <n-back-top :bottom="100"> </n-back-top>
          </n-scrollbar>
        </n-layout-content>
      </n-layout>
...
export default defineComponent({
  ...
  methods: {
    ...
    changeCollapsedWidth(e) {
      ...
      console.log("changeCollapsedWidth(app)");
    },
  },
  mounted() {
    // console.clear();
    ...
    console.log(
      "Main page mounted! " +
        (new Date().getTime() - window.app_beforeCreate_time) +
        " ms for loading."
    );
